...
#ifndef _EmuTextUILcdILI9341_h_
#define _EmuTextUILcdILI9341_h_
...
class EmuTextUILcdILI9341 : public TextUILcd, public wxPanel
{
    private:
        wxWindow *parent;
        unsigned int width;
    ...
    public:
        EmuTextUILcdILI9341( wxWindow *parent, wxWindowID id);
